...
const Register = () => {
  const [formData, setFormData] = useState({
    name: '',  // Changed from username to name to match backend expectations
    email: '',
    password: '',
    role: 'student',
  });
      ...
      >
        ...
        >
          <motion.h2 
            ...
            style={{ background: 'linear-gradient(90deg, #6820C6 0%, #6563FF 65.5%, #AB04B7 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}
          >
            Create an account
          </motion.h2>
