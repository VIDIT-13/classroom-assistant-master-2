...
// Import your coding assignment creation component
import CodingAssignmentCreate from "./CodingAssignmentCreate";

const AssignmentCreate = () => {
  // Assignment type state
  const [assignmentType, setAssignmentType] = useState("text"); // 'text' or 'coding'

  // Existing state for text assignment
  ...
  const inputClasses =
    "w-full px-4 py-3 border border-purple-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent";
  const labelClasses = "block text-gray-700 font-medium mb-2";
  const fileInputWrapperClasses =
    "w-full px-4 py-3 border border-purple-200 rounded-lg hover:bg-purple-50 transition-colors cursor-pointer";
      ...
      >
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-6">
            <label className={labelClasses}>Assignment Type</label>
            <div className="flex space-x-8">
              <label className="flex items-center cursor-pointer">
                ...
                <span className="ml-2 text-sm font-medium text-gray-900 flex items-center">
                  <FaRegFileAlt className="mr-1 text-purple-500" /> Text
                  Assignment
                </span>
              </label>
              <label className="flex items-center cursor-pointer">
                <input
                  ...
                  name="assignmentType"
                  value="coding"
                  checked={assignmentType === "coding"}
                  onChange={handleAssignmentTypeChange}
                  className="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 focus:ring-purple-500 focus:ring-2"
                />
                <span className="ml-2 text-sm font-medium text-gray-900 flex items-center">
                  <FaCode className="mr-1 text-purple-500" /> Coding Assignment
                </span>
              </label>
            </div>
          </motion.div>
          ...
          {assignmentType === "text" ? (
            ...
            // Coding assignment create component
